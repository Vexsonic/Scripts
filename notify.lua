-- Akali Notification System v2
-- Designed to work both as a standalone module and via loadstring
...
function NotificationSystem.Notify(Properties)
...
-- Return the module for require or loadstring
